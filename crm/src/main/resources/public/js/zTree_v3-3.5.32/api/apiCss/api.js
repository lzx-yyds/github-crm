var apiContent = {
	...
	_init: function() {
		...
		var setting_nodes =[
			{id:1, pId:0, t:"public.static.js.user.setting.ftlh", name:"var setting = {", open:true},
		...
		var function_nodes =[
			...
			{id:401, pId:4, t:"public.static.js.user.setting.ftlh", name:"public.static.js.user.setting.ftlh", iconSkin:"core", showAPI:true},
	...
	openAPI: function() {
		if (apiContent.searchNodes.length > 0) {
			...
			if (node.tId.indexOf("public.static.js.user.setting.ftlh") > -1) {
